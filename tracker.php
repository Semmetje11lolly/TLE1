    ...
    <form action="" method="post">
        ...
        <div class="form-content">
            <div class="form-option">
                ...
                <h4>Angry</h4>
                <input class="input" id="angry" type="checkbox" name="mood" value="Angry"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="sad"><i class="fa-regular fa-face-frown"></i></label>
                <h4>Sad</h4>
                <input class="input" id="sad" type="checkbox" name="mood" value="Sad"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="meh"><i class="fa-regular fa-face-meh-blank"></i></label>
                <h4>Meh</h4>
                <input class="input" id="meh" type="checkbox" name="mood" value="Meh"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="good"><i class="fa-regular fa-face-smile"></i></label>
                <h4>Good</h4>
                <input class="input" id="good" type="checkbox" name="mood" value="Good"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="happy"><i class="fa-regular fa-face-laugh-squint"></i></label>
                <h4>Happy</h4>
                <input class="input" id="happy" type="checkbox" name="mood" value="Happy"/>
            </div>
        </div>
        ...
        <div class="form-content">
            <div class="form-option">
                ...
                <h4>Low</h4>
                <input class="input" id="low" type="checkbox" name="energy" value="Low"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="alright"><i class="fa-solid fa-2"></i></label>
                <h4>Meh</h4>
                <input class="input" id="alright" type="checkbox" name="energy" value="Meh"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="middle"><i class="fa-solid fa-3"></i></label>
                <h4>Middle</h4>
                <input class="input" id="middle" type="checkbox" name="energy" value="Middle"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="high"><i class="fa-solid fa-4"></i></label>
                <h4>High</h4>
                <input class="input" id="high" type="checkbox" name="energy" value="High"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="full"><i class="fa-solid fa-5"></i></label>
                <h4>Full</h4>
                <input class="input" id="full" type="checkbox" name="energy" value="Full"/>
            </div>
        </div>
        ...
        <div class="form-content">
            <div class="form-option">
                ...
                <h4>Smoking</h4>
                <input class="input" id="smoking" type="checkbox" name="bad-habit" value="Smoking"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="nail-bitting"><i class="fa-solid fa-hand-point-up"></i></label>
                <h4>Nail Bitting</h4>
                <input class="input" id="nail-bitting" type="checkbox" name="bad-habit" value="Nail Bitting"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="procrastinating"><i class="fa-solid fa-clock"></i></label>
                <h4>Procrastinating</h4>
                <input class="input" id="procrastinating" type="checkbox" name="bad-habit" value="Procrastinating"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="alcohol"><i class="fa-solid fa-wine-glass"></i></label>
                <h4>Alcohol</h4>
                <input class="input" id="alcohol" type="checkbox" name="bad-habit" value="Alcohol"/>
            </div>
        </div>
        ...
        <div class="form-content">
            <div class="form-option">
                ...
                <h4>Reading</h4>
                <input class="input" id="reading" type="checkbox" name="hobbies" value="Reading"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="gaming"><i class="fa-solid fa-gamepad"></i></label>
                <h4>Gaming</h4>
                <input class="input" id="gaming" type="checkbox" name="hobbies" value="Gaming"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="music"><i class="fa-solid fa-music"></i></label>
                <h4>Music</h4>
                <input class="input" id="music" type="checkbox" name="hobbies" value="Music"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="writing"><i class="fa-solid fa-pen"></i></label>
                <h4>Writing</h4>
                <input class="input" id="writing" type="checkbox" name="hobbies" value="Writing"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="film"><i class="fa-solid fa-video"></i></label>
                <h4>Film</h4>
                <input class="input" id="film" type="checkbox" name="hobbies" value="Film"/>
            </div>
        </div>
        ...
        <div class="form-content">
            <div class="form-option">
                ...
                <h4>Home</h4>
                <input class="input" id="home" type="checkbox" name="locations" value="Home"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="work"><i class="fa-solid fa-briefcase"></i></label>
                <h4>Work</h4>
                <input class="input" id="work" type="checkbox" name="locations" value="Work"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="school"><i class="fa-solid fa-school"></i></label>
                <h4>School</h4>
                <input class="input" id="school" type="checkbox" name="locations" value="School"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="park"><i class="fa-solid fa-tree"></i></label>
                <h4>Park</h4>
                <input class="input" id="park" type="checkbox" name="locations" value="Park"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="city"><i class="fa-solid fa-city"></i></label>
                <h4>City</h4>
                <input class="input" id="city" type="checkbox" name="locations" value="City"/>
            </div>
        </div>
        ...
        <div class="form-content">
            ...
            <div class="form-option">
                ...
                <h4>Hours</h4>
                <input class="input" id="eight-or-more" type="checkbox" name="sleep" value="Eight or more"/>
            </div>
        </div>
        ...
        <div class="form-content">
            <div class="form-option">
                ...
                <h4>Stressed</h4>
                <input class="input" id="stressed" type="checkbox" name="emotions" value="Stressed"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="insecure"><i class="fa-solid fa-face-grimace"></i></label>
                <h4>Insecure</h4>
                <input class="input" id="insecure" type="checkbox" name="emotions" value="Insecure"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="relaxed"><i class="fa-solid fa-face-smile-beam"></i></label>
                <h4>Relaxed</h4>
                <input class="input" id="relaxed" type="checkbox" name="emotions" value="Relaxed"/>
            </div>
            <div class="form-option">
                <label class="label-form" for="bored"><i class="fa-solid fa-face-meh"></i></label>
                <h4>Bored</h4>
                <input class="input" id="bored" type="checkbox" name="emotions" value="Bored"/>
            </div>
        </div>
