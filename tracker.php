...
$query = "SELECT * from `diaries` WHERE `date` = '$today' AND `account_id` = $accountID";
...
<head>
    ...
    <title>Novara Health • Tracker</title>
</head>
<body>
...
<main>
    ...
    <?php if ($alreadyFilled) : ?>
        ...
        <section class="alreadyFilled">
            <h1>Whoops!</h1>
            Looks like you already tracked your stats today!<br><br>
            <h3>Do you want to start over?</h3>
            <div class="buttons">
                <a href="index.php" class="no-button">No</a>
        ...
        <form action="" method="post">
            ...
            <div class="form-content">
                ...
                <div class="form-option">
                    ...
                    <input class="input" id="procrastinating" type="checkbox" name="bad_habit[]"
            ...
            <div class="form-content">
                <div class="form-option">
                    ...
                    <h4>Hours</h4>
                    <input class="input" id="six-or-less-hours" type="checkbox" name="sleep[]"
                           value="Six or less hours"/>
                </div>
                <div class="form-option">
                    ...
                    <h4>Hours</h4>
                    <input class="input" id="six-to-seven-hours" type="checkbox" name="sleep[]"
                           value="Six to seven hours"/>
                </div>
                <div class="form-option">
